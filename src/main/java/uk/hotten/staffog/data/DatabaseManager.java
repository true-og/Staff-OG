...
public class DatabaseManager {
    ...
    public DatabaseManager(JavaPlugin plugin) {
        ...
        for (PunishType pt : PunishType.values())
            checkPunishmentTable(pt.getTable());
        checkKickTable();
    ...
    public Connection createConnection() throws SQLException, ClassNotFoundException {
        ...
        synchronized (this) {
            ...
            return DriverManager.getConnection(
                    "jdbc:" + driverUrl + "://" + host + ":" + port + "/" + database + "?userSSL=false", username,
                    password);
    ...
    private void checkPunishmentTable(String table) {
        ...
        try (Connection connection = createConnection()) {
            ...
            String sql = "CREATE TABLE `" + table + "` (" + " `id` bigint(20) NOT NULL AUTO_INCREMENT,"
                    + " `uuid` varchar(36) NOT NULL," + " `reason` varchar(2048) NOT NULL,"
                    + " `by_uuid` varchar(36) DEFAULT NULL," + " `by_name` varchar(128) DEFAULT NULL,"
                    + " `removed_uuid` varchar(36) DEFAULT NULL," + " `removed_name` varchar(128) DEFAULT NULL,"
                    + " `removed_reason` varchar(2048) DEFAULT NULL," + " `removed_time` bigint(20) DEFAULT NULL,"
                    + " `time` bigint(20) NOT NULL," + " `until` bigint(20) NOT NULL," + " `active` bit(1) NOT NULL,"
    ...
    private void checkKickTable() {
        ...
        try (Connection connection = createConnection()) {
            ...
            String sql = "CREATE TABLE `staffog_kick` (" + " `id` bigint(20) NOT NULL AUTO_INCREMENT,"
                    + " `uuid` varchar(36) NOT NULL," + " `reason` varchar(2048) NOT NULL,"
                    + " `by_uuid` varchar(36) NOT NULL," + " `by_name` varchar(128) NOT NULL,"
                    + " `time` bigint(20) NOT NULL," + " PRIMARY KEY (`id`)"
    ...
    private void checkNameHistoryTable() {
        ...
        try (Connection connection = createConnection()) {
            ...
            String sql = "CREATE TABLE `staffog_history` (" + " `id` int NOT NULL AUTO_INCREMENT,"
                    + " `date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP," + " `name` varchar(16) NOT NULL,"
    ...
    private void checkTaskTable() {
        ...
        try (Connection connection = createConnection()) {
            ...
            String sql = "CREATE TABLE `staffog_task` (" + " `id` int(11) NOT NULL AUTO_INCREMENT,"
                    + " `task` varchar(2048) NOT NULL," + " `data` varchar(2048) NOT NULL," + " PRIMARY KEY (`id`)"
                    + ") ENGINE=InnoDB DEFAULT CHARSET=utf8mb4";
    ...
    private void checkStatTable() {
        ...
        try (Connection connection = createConnection()) {
            ...
            String sql = "CREATE TABLE `staffog_stat` (" + " `name` varchar(2048) NOT NULL,"
                    + " `stat` varchar(2048) NOT NULL," + " UNIQUE KEY `name` (`name`) USING HASH"
                    + ") ENGINE=InnoDB DEFAULT CHARSET=utf8mb4";
    ...
    private boolean doesStatIncludeEntry(String entry) {
        ...
        try (Connection connection = createConnection()) {
            ...
            return dsl.fetchExists(dsl.selectFrom(STAFFOG_STAT).where(STAFFOG_STAT.NAME.eq(entry)));
    ...
    public void setStatEntry(String entry, String stat) {
        ...
        try (Connection connection = createConnection()) {
            ...
            if (!doesStatIncludeEntry(entry)) {
                ...
                dsl.insertInto(STAFFOG_STAT).set(STAFFOG_STAT.NAME, entry).set(STAFFOG_STAT.STAT, stat).execute();

            } else {

                dsl.update(STAFFOG_STAT).set(STAFFOG_STAT.STAT, stat).where(STAFFOG_STAT.NAME.eq(entry)).execute();
    ...
    private void checkWebTable() {
        ...
        try (Connection connection = createConnection()) {
            ...
            String sql = "CREATE TABLE `staffog_web` (" + " `id` int(11) NOT NULL AUTO_INCREMENT,"
                    + " `username` varchar(128) NOT NULL," + " `uuid` varchar(36) NOT NULL,"
                    + " `password` varchar(2048) NOT NULL," + " `active` bit(1) NOT NULL DEFAULT b'1',"
                    + " `admin` bit(1) NOT NULL," + " PRIMARY KEY (`id`),"
                    + " UNIQUE KEY `username` (`username`,`uuid`)" + ") ENGINE=InnoDB DEFAULT CHARSET=utf8mb4";
    ...
    private void checkLinkCodeTable() {
        ...
        try (Connection connection = createConnection()) {
            ...
            String sql = "CREATE TABLE `staffog_linkcode` (" + " `uuid` varchar(36) NOT NULL,"
                    + " `code` varchar(5) NOT NULL," + " `admin` bit(1) NOT NULL," + " UNIQUE KEY `uuid` (`uuid`)"
                    + ") ENGINE=InnoDB DEFAULT CHARSET=utf8mb4";
    ...
    private void checkStaffIpTable() {
        ...
        try (Connection connection = createConnection()) {
            ...
            String sql = "CREATE TABLE `staffog_staffip` (" + " `id` int(11) NOT NULL AUTO_INCREMENT,"
                    + " `ip` varchar(15) NOT NULL," + " `uuid` varchar(36) NOT NULL," + " `initial` bit(1) NOT NULL,"
                    + " `panel_acknowledged` bit(1) NOT NULL," + " `panel_verified` bit(1) NOT NULL,"
                    + " `game_verified` bit(1) NOT NULL," + " PRIMARY KEY (`id`)"
                    + ") ENGINE=InnoDB DEFAULT CHARSET=utf8mb4";
    ...
    private void checkAuditTable() {
        ...
        try (Connection connection = createConnection()) {
            ...
            String sql = "CREATE TABLE `staffog_audit` (" + " `id` int(11) NOT NULL AUTO_INCREMENT,"
                    + " `type` varchar(2048) NOT NULL," + " `data` varchar(2048) NOT NULL,"
                    + " `time` bigint(20) NOT NULL," + " PRIMARY KEY (`id`)"
                    + ") ENGINE=InnoDB DEFAULT CHARSET=utf8mb4";
    ...
    private void checkAppealTable() {
        ...
        try (Connection connection = createConnection()) {
            ...
            String sql = "CREATE TABLE `staffog_appeal` (" + " `id` int NOT NULL AUTO_INCREMENT,"
                    + " `uuid` varchar(36) COLLATE utf8mb4_general_ci NOT NULL," + " `time` bigint NOT NULL,"
                    + " `type` varchar(128) COLLATE utf8mb4_general_ci NOT NULL," + " `pid` int NOT NULL,"
                    ...
                    + " `verdict` bit(1) DEFAULT NULL," + " `verdict_time` bigint DEFAULT NULL,"
                    + " `comment` varchar(2048) COLLATE utf8mb4_general_ci DEFAULT NULL," + " PRIMARY KEY (`id`)"
                    + ") ENGINE=InnoDB DEFAULT CHARSET=utf8mb4";
    ...
    private void checkReportTable() {
        ...
        try (Connection connection = createConnection()) {
            ...
            String sql = "CREATE TABLE `staffog_report` (" + " `id` int NOT NULL AUTO_INCREMENT,"
                    + " `uuid` varchar(36) COLLATE utf8mb4_general_ci NOT NULL,"
                    + " `by_uuid` varchar(36) COLLATE utf8mb4_general_ci NOT NULL," + " `time` bigint NOT NULL,"
                    ...
                    + " `crid` int DEFAULT NULL," + " `open` bit(1) NOT NULL DEFAULT b'1',"
                    + " `assigned` varchar(36) COLLATE utf8mb4_general_ci DEFAULT NULL,"
                    + " `verdict` bit(1) DEFAULT NULL," + " `verdict_time` bigint DEFAULT NULL,"
                    + " `comment` varchar(2048) COLLATE utf8mb4_general_ci DEFAULT NULL," + " PRIMARY KEY (`id`)"
                    + ") ENGINE=InnoDB DEFAULT CHARSET=utf8mb4";
    ...
    private void checkChatReportTable() {
        ...
        try (Connection connection = createConnection()) {
            ...
            String sql = "CREATE TABLE `staffog_chatreport` (" + " `id` int(11) NOT NULL AUTO_INCREMENT,"
                    + " `uuid` varchar(36) NOT NULL," + " `by_uuid` varchar(36) NOT NULL,"
                    + " `time` bigint(20) NOT NULL," + " `messages` varchar(2048) NOT NULL," + " PRIMARY KEY (`id`)"
                    + ") ENGINE=InnoDB DEFAULT CHARSET=utf8mb4";
