...
public class Staffog extends SchemaImpl {
    ...
    public final List<Table<?>> getTables() {
        ...
        return Arrays.asList(StaffogAppeal.STAFFOG_APPEAL, StaffogAudit.STAFFOG_AUDIT, StaffogBan.STAFFOG_BAN,
                StaffogChatreport.STAFFOG_CHATREPORT, StaffogHistory.STAFFOG_HISTORY, StaffogKick.STAFFOG_KICK,
                StaffogLinkcode.STAFFOG_LINKCODE, StaffogMute.STAFFOG_MUTE, StaffogReport.STAFFOG_REPORT,
                StaffogStaffip.STAFFOG_STAFFIP, StaffogStat.STAFFOG_STAT, StaffogTask.STAFFOG_TASK,
