...
public class StaffogBan extends TableImpl<StaffogBanRecord> {
     ...
     */
    public final TableField<StaffogBanRecord, Long> ID = createField(DSL.name("id"),
            SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>staffog.staffog_ban.uuid</code>.
     */
    public final TableField<StaffogBanRecord, String> UUID = createField(DSL.name("uuid"),
            SQLDataType.VARCHAR(36).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_ban.reason</code>.
     */
    public final TableField<StaffogBanRecord, String> REASON = createField(DSL.name("reason"),
            SQLDataType.VARCHAR(2048).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_ban.by_uuid</code>.
     */
    public final TableField<StaffogBanRecord, String> BY_UUID = createField(DSL.name("by_uuid"),
            SQLDataType.VARCHAR(36), this, "");

    /**
     * The column <code>staffog.staffog_ban.by_name</code>.
     */
    public final TableField<StaffogBanRecord, String> BY_NAME = createField(DSL.name("by_name"),
            SQLDataType.VARCHAR(128), this, "");

    /**
     * The column <code>staffog.staffog_ban.removed_uuid</code>.
     */
    public final TableField<StaffogBanRecord, String> REMOVED_UUID = createField(DSL.name("removed_uuid"),
            SQLDataType.VARCHAR(36), this, "");

    /**
     * The column <code>staffog.staffog_ban.removed_name</code>.
     */
    public final TableField<StaffogBanRecord, String> REMOVED_NAME = createField(DSL.name("removed_name"),
            SQLDataType.VARCHAR(128), this, "");

    /**
     * The column <code>staffog.staffog_ban.removed_reason</code>.
     */
    public final TableField<StaffogBanRecord, String> REMOVED_REASON = createField(DSL.name("removed_reason"),
            SQLDataType.VARCHAR(2048), this, "");

    /**
     * The column <code>staffog.staffog_ban.removed_time</code>.
     */
    public final TableField<StaffogBanRecord, Long> REMOVED_TIME = createField(DSL.name("removed_time"),
            SQLDataType.BIGINT, this, "");

    /**
     * The column <code>staffog.staffog_ban.time</code>.
     */
    public final TableField<StaffogBanRecord, Long> TIME = createField(DSL.name("time"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_ban.until</code>.
     */
    public final TableField<StaffogBanRecord, Long> UNTIL = createField(DSL.name("until"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_ban.active</code>.
     */
    public final TableField<StaffogBanRecord, Boolean> ACTIVE = createField(DSL.name("active"),
