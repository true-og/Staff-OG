...
public class StaffogWeb extends TableImpl<StaffogWebRecord> {
     ...
     */
    public final TableField<StaffogWebRecord, Integer> ID =
            createField(DSL.name("id"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_web.username</code>.
     */
    public final TableField<StaffogWebRecord, String> USERNAME =
            createField(DSL.name("username"), SQLDataType.VARCHAR(128).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_web.uuid</code>.
     */
    public final TableField<StaffogWebRecord, String> UUID =
            createField(DSL.name("uuid"), SQLDataType.VARCHAR(36).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_web.password</code>.
     */
    public final TableField<StaffogWebRecord, String> PASSWORD =
            createField(DSL.name("password"), SQLDataType.VARCHAR(2048).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_web.active</code>.
     */
    public final TableField<StaffogWebRecord, Boolean> ACTIVE = createField(
            DSL.name("active"),
     ...
     */
    public final TableField<StaffogWebRecord, Boolean> ADMIN =
            createField(DSL.name("admin"), SQLDataType.BIT.nullable(false), this, "");
