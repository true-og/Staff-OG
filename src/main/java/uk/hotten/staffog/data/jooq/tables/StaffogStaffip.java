...
public class StaffogStaffip extends TableImpl<StaffogStaffipRecord> {
     ...
     */
    public final TableField<StaffogStaffipRecord, Integer> ID = createField(DSL.name("id"),
            SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>staffog.staffog_staffip.ip</code>.
     */
    public final TableField<StaffogStaffipRecord, String> IP = createField(DSL.name("ip"),
            SQLDataType.VARCHAR(15).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_staffip.uuid</code>.
     */
    public final TableField<StaffogStaffipRecord, String> UUID = createField(DSL.name("uuid"),
            SQLDataType.VARCHAR(36).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_staffip.initial</code>.
     */
    public final TableField<StaffogStaffipRecord, Boolean> INITIAL = createField(DSL.name("initial"),
            SQLDataType.BIT.nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_staffip.panel_acknowledged</code>.
     */
    public final TableField<StaffogStaffipRecord, Boolean> PANEL_ACKNOWLEDGED = createField(
            DSL.name("panel_acknowledged"), SQLDataType.BIT.nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_staffip.panel_verified</code>.
     */
    public final TableField<StaffogStaffipRecord, Boolean> PANEL_VERIFIED = createField(DSL.name("panel_verified"),
            SQLDataType.BIT.nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_staffip.game_verified</code>.
     */
    public final TableField<StaffogStaffipRecord, Boolean> GAME_VERIFIED = createField(DSL.name("game_verified"),
            SQLDataType.BIT.nullable(false), this, "");
    ...
    public <U> SelectField<U> mapping(
            Function7<? super Integer, ? super String, ? super String, ? super Boolean, ? super Boolean, ? super Boolean, ? super Boolean, ? extends U> from)
    {
