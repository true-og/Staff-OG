...
public class StaffogReport extends TableImpl<StaffogReportRecord> {
     ...
     */
    public final TableField<StaffogReportRecord, Integer> ID =
     ...
     */
    public final TableField<StaffogReportRecord, String> UUID =
            createField(DSL.name("uuid"), SQLDataType.VARCHAR(36).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_report.by_uuid</code>.
     */
    public final TableField<StaffogReportRecord, String> BY_UUID =
            createField(DSL.name("by_uuid"), SQLDataType.VARCHAR(36).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_report.time</code>.
     */
    public final TableField<StaffogReportRecord, Long> TIME =
            createField(DSL.name("time"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_report.type</code>.
     */
    public final TableField<StaffogReportRecord, String> TYPE =
            createField(DSL.name("type"), SQLDataType.VARCHAR(128).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_report.reason</code>.
     */
    public final TableField<StaffogReportRecord, String> REASON =
     ...
     */
    public final TableField<StaffogReportRecord, String> EVIDENCE = createField(
            DSL.name("evidence"),
            SQLDataType.VARCHAR(2048).defaultValue(DSL.inline("[]", SQLDataType.VARCHAR)),
            this,
            "");
     ...
     */
    public final TableField<StaffogReportRecord, Integer> CRID =
            createField(DSL.name("crid"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>staffog.staffog_report.open</code>.
     */
    public final TableField<StaffogReportRecord, Boolean> OPEN = createField(
            DSL.name("open"),
            SQLDataType.BIT.nullable(false).defaultValue(DSL.inline("b'1'", SQLDataType.BIT)),
            this,
            "");
     ...
     */
    public final TableField<StaffogReportRecord, String> ASSIGNED =
            createField(DSL.name("assigned"), SQLDataType.VARCHAR(36), this, "");

    /**
     * The column <code>staffog.staffog_report.verdict</code>.
     */
    public final TableField<StaffogReportRecord, Boolean> VERDICT =
            createField(DSL.name("verdict"), SQLDataType.BIT, this, "");

    /**
     * The column <code>staffog.staffog_report.verdict_time</code>.
     */
    public final TableField<StaffogReportRecord, Long> VERDICT_TIME =
            createField(DSL.name("verdict_time"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>staffog.staffog_report.comment</code>.
     */
    public final TableField<StaffogReportRecord, String> COMMENT =
            createField(DSL.name("comment"), SQLDataType.VARCHAR(2048), this, "");
    ...
    @Override
    public Row13<Integer, String, String, Long, String, String, String, Integer, Boolean, String, Boolean, Long, String>
            fieldsRow() {
