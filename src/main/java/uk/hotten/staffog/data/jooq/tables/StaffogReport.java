...
public class StaffogReport extends TableImpl<StaffogReportRecord> {
     ...
     */
    public final TableField<StaffogReportRecord, Integer> ID = createField(DSL.name("id"),
            SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>staffog.staffog_report.uuid</code>.
     */
    public final TableField<StaffogReportRecord, String> UUID = createField(DSL.name("uuid"),
            SQLDataType.VARCHAR(36).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_report.by_uuid</code>.
     */
    public final TableField<StaffogReportRecord, String> BY_UUID = createField(DSL.name("by_uuid"),
            SQLDataType.VARCHAR(36).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_report.time</code>.
     */
    public final TableField<StaffogReportRecord, Long> TIME = createField(DSL.name("time"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_report.type</code>.
     */
    public final TableField<StaffogReportRecord, String> TYPE = createField(DSL.name("type"),
            SQLDataType.VARCHAR(128).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_report.reason</code>.
     */
    public final TableField<StaffogReportRecord, String> REASON = createField(DSL.name("reason"),
            SQLDataType.VARCHAR(2048).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_report.evidence</code>.
     */
    public final TableField<StaffogReportRecord, String> EVIDENCE = createField(DSL.name("evidence"),
            SQLDataType.VARCHAR(2048).defaultValue(DSL.inline("[]", SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>staffog.staffog_report.crid</code>.
     */
    public final TableField<StaffogReportRecord, Integer> CRID = createField(DSL.name("crid"), SQLDataType.INTEGER,
            this, "");

    /**
     * The column <code>staffog.staffog_report.open</code>.
     */
    public final TableField<StaffogReportRecord, Boolean> OPEN = createField(DSL.name("open"),
            SQLDataType.BIT.nullable(false).defaultValue(DSL.inline("b'1'", SQLDataType.BIT)), this, "");

    /**
     * The column <code>staffog.staffog_report.assigned</code>.
     */
    public final TableField<StaffogReportRecord, String> ASSIGNED = createField(DSL.name("assigned"),
            SQLDataType.VARCHAR(36), this, "");

    /**
     * The column <code>staffog.staffog_report.verdict</code>.
     */
    public final TableField<StaffogReportRecord, Boolean> VERDICT = createField(DSL.name("verdict"), SQLDataType.BIT,
            this, "");

    /**
     * The column <code>staffog.staffog_report.verdict_time</code>.
     */
    public final TableField<StaffogReportRecord, Long> VERDICT_TIME = createField(DSL.name("verdict_time"),
            SQLDataType.BIGINT, this, "");

    /**
     * The column <code>staffog.staffog_report.comment</code>.
     */
    public final TableField<StaffogReportRecord, String> COMMENT = createField(DSL.name("comment"),
            SQLDataType.VARCHAR(2048), this, "");
    ...
    public <U> SelectField<U> mapping(
            Function13<? super Integer, ? super String, ? super String, ? super Long, ? super String, ? super String, ? super String, ? super Integer, ? super Boolean, ? super String, ? super Boolean, ? super Long, ? super String, ? extends U> from)
    {
