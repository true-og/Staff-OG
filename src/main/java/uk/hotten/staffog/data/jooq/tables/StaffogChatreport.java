...
public class StaffogChatreport extends TableImpl<StaffogChatreportRecord> {
     ...
     */
    public final TableField<StaffogChatreportRecord, Integer> ID =
     ...
     */
    public final TableField<StaffogChatreportRecord, String> UUID =
     ...
     */
    public final TableField<StaffogChatreportRecord, String> BY_UUID =
     ...
     */
    public final TableField<StaffogChatreportRecord, Long> TIME =
            createField(DSL.name("time"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_chatreport.messages</code>.
     */
    public final TableField<StaffogChatreportRecord, String> MESSAGES =
            createField(DSL.name("messages"), SQLDataType.VARCHAR(2048).nullable(false), this, "");
    ...
    public <U> SelectField<U> mapping(
            Function5<? super Integer, ? super String, ? super String, ? super Long, ? super String, ? extends U>
                    from) {
