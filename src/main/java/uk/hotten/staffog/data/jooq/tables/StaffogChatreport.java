...
public class StaffogChatreport extends TableImpl<StaffogChatreportRecord> {
     ...
     */
    public final TableField<StaffogChatreportRecord, Integer> ID = createField(DSL.name("id"),
            SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>staffog.staffog_chatreport.uuid</code>.
     */
    public final TableField<StaffogChatreportRecord, String> UUID = createField(DSL.name("uuid"),
            SQLDataType.VARCHAR(36).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_chatreport.by_uuid</code>.
     */
    public final TableField<StaffogChatreportRecord, String> BY_UUID = createField(DSL.name("by_uuid"),
            SQLDataType.VARCHAR(36).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_chatreport.time</code>.
     */
    public final TableField<StaffogChatreportRecord, Long> TIME = createField(DSL.name("time"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_chatreport.messages</code>.
     */
    public final TableField<StaffogChatreportRecord, String> MESSAGES = createField(DSL.name("messages"),
    ...
    public <U> SelectField<U> mapping(
            Function5<? super Integer, ? super String, ? super String, ? super Long, ? super String, ? extends U> from)
    {
