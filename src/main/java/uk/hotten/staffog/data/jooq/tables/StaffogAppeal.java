...
public class StaffogAppeal extends TableImpl<StaffogAppealRecord> {
     ...
     */
    public final TableField<StaffogAppealRecord, Integer> ID = createField(DSL.name("id"),
            SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>staffog.staffog_appeal.uuid</code>.
     */
    public final TableField<StaffogAppealRecord, String> UUID = createField(DSL.name("uuid"),
            SQLDataType.VARCHAR(36).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_appeal.time</code>.
     */
    public final TableField<StaffogAppealRecord, Long> TIME = createField(DSL.name("time"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_appeal.type</code>.
     */
    public final TableField<StaffogAppealRecord, String> TYPE = createField(DSL.name("type"),
            SQLDataType.VARCHAR(128).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_appeal.pid</code>.
     */
    public final TableField<StaffogAppealRecord, Integer> PID = createField(DSL.name("pid"),
            SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_appeal.reason</code>.
     */
    public final TableField<StaffogAppealRecord, String> REASON = createField(DSL.name("reason"),
            SQLDataType.VARCHAR(2048).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_appeal.evidence</code>.
     */
    public final TableField<StaffogAppealRecord, String> EVIDENCE = createField(DSL.name("evidence"),
            SQLDataType.VARCHAR(2048).nullable(false).defaultValue(DSL.inline("[]", SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>staffog.staffog_appeal.open</code>.
     */
    public final TableField<StaffogAppealRecord, Boolean> OPEN = createField(DSL.name("open"),
     ...
     */
    public final TableField<StaffogAppealRecord, String> ASSIGNED = createField(DSL.name("assigned"),
            SQLDataType.VARCHAR(36), this, "");

    /**
     * The column <code>staffog.staffog_appeal.verdict</code>.
     */
    public final TableField<StaffogAppealRecord, Boolean> VERDICT = createField(DSL.name("verdict"), SQLDataType.BIT,
            this, "");

    /**
     * The column <code>staffog.staffog_appeal.verdict_time</code>.
     */
    public final TableField<StaffogAppealRecord, Long> VERDICT_TIME = createField(DSL.name("verdict_time"),
            SQLDataType.BIGINT, this, "");

    /**
     * The column <code>staffog.staffog_appeal.comment</code>.
     */
    public final TableField<StaffogAppealRecord, String> COMMENT = createField(DSL.name("comment"),
    ...
    public <U> SelectField<U> mapping(
            Function12<? super Integer, ? super String, ? super Long, ? super String, ? super Integer, ? super String, ? super String, ? super Boolean, ? super String, ? super Boolean, ? super Long, ? super String, ? extends U> from)
    {
