...
public class StaffogAppeal extends TableImpl<StaffogAppealRecord> {
     ...
     */
    public final TableField<StaffogAppealRecord, Integer> ID =
     ...
     */
    public final TableField<StaffogAppealRecord, String> EVIDENCE = createField(
            DSL.name("evidence"),
            SQLDataType.VARCHAR(2048).nullable(false).defaultValue(DSL.inline("[]", SQLDataType.VARCHAR)),
            this,
            "");
     ...
     */
    public final TableField<StaffogAppealRecord, Boolean> OPEN = createField(
            DSL.name("open"),
