...
public class StaffogHistory extends TableImpl<StaffogHistoryRecord> {
     ...
     */
    public final TableField<StaffogHistoryRecord, Integer> ID = createField(DSL.name("id"),
            SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>staffog.staffog_history.date</code>.
     */
    public final TableField<StaffogHistoryRecord, LocalDateTime> DATE = createField(DSL.name("date"),
     ...
     */
    public final TableField<StaffogHistoryRecord, String> NAME = createField(DSL.name("name"),
            SQLDataType.VARCHAR(16).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_history.uuid</code>.
     */
    public final TableField<StaffogHistoryRecord, String> UUID = createField(DSL.name("uuid"),
    ...
    public <U> SelectField<U> mapping(
            Function4<? super Integer, ? super LocalDateTime, ? super String, ? super String, ? extends U> from)
    {
