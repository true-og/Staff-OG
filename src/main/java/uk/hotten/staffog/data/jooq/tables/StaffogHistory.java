...
public class StaffogHistory extends TableImpl<StaffogHistoryRecord> {
     ...
     */
    public final TableField<StaffogHistoryRecord, Integer> ID =
     ...
     */
    public final TableField<StaffogHistoryRecord, LocalDateTime> DATE = createField(
            DSL.name("date"),
     ...
     */
    public final TableField<StaffogHistoryRecord, String> NAME =
            createField(DSL.name("name"), SQLDataType.VARCHAR(16).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_history.uuid</code>.
     */
    public final TableField<StaffogHistoryRecord, String> UUID =
