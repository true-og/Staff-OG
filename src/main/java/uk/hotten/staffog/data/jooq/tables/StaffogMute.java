...
public class StaffogMute extends TableImpl<StaffogMuteRecord> {
     ...
     */
    public final TableField<StaffogMuteRecord, Long> ID = createField(DSL.name("id"),
            SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>staffog.staffog_mute.uuid</code>.
     */
    public final TableField<StaffogMuteRecord, String> UUID = createField(DSL.name("uuid"),
            SQLDataType.VARCHAR(36).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_mute.reason</code>.
     */
    public final TableField<StaffogMuteRecord, String> REASON = createField(DSL.name("reason"),
            SQLDataType.VARCHAR(2048).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_mute.by_uuid</code>.
     */
    public final TableField<StaffogMuteRecord, String> BY_UUID = createField(DSL.name("by_uuid"),
            SQLDataType.VARCHAR(36), this, "");

    /**
     * The column <code>staffog.staffog_mute.by_name</code>.
     */
    public final TableField<StaffogMuteRecord, String> BY_NAME = createField(DSL.name("by_name"),
            SQLDataType.VARCHAR(128), this, "");

    /**
     * The column <code>staffog.staffog_mute.removed_uuid</code>.
     */
    public final TableField<StaffogMuteRecord, String> REMOVED_UUID = createField(DSL.name("removed_uuid"),
            SQLDataType.VARCHAR(36), this, "");

    /**
     * The column <code>staffog.staffog_mute.removed_name</code>.
     */
    public final TableField<StaffogMuteRecord, String> REMOVED_NAME = createField(DSL.name("removed_name"),
            SQLDataType.VARCHAR(128), this, "");

    /**
     * The column <code>staffog.staffog_mute.removed_reason</code>.
     */
    public final TableField<StaffogMuteRecord, String> REMOVED_REASON = createField(DSL.name("removed_reason"),
            SQLDataType.VARCHAR(2048), this, "");

    /**
     * The column <code>staffog.staffog_mute.removed_time</code>.
     */
    public final TableField<StaffogMuteRecord, Long> REMOVED_TIME = createField(DSL.name("removed_time"),
            SQLDataType.BIGINT, this, "");

    /**
     * The column <code>staffog.staffog_mute.time</code>.
     */
    public final TableField<StaffogMuteRecord, Long> TIME = createField(DSL.name("time"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_mute.until</code>.
     */
    public final TableField<StaffogMuteRecord, Long> UNTIL = createField(DSL.name("until"),
            SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_mute.active</code>.
     */
    public final TableField<StaffogMuteRecord, Boolean> ACTIVE = createField(DSL.name("active"),
            SQLDataType.BIT.nullable(false), this, "");
    ...
    public <U> SelectField<U> mapping(
            Function12<? super Long, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super Long, ? super Long, ? super Long, ? super Boolean, ? extends U> from)
    {
