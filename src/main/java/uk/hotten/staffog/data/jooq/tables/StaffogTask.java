...
public class StaffogTask extends TableImpl<StaffogTaskRecord> {
     ...
     */
    public final TableField<StaffogTaskRecord, Integer> ID =
     ...
     */
    public final TableField<StaffogTaskRecord, String> TASK =
            createField(DSL.name("task"), SQLDataType.VARCHAR(2048).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_task.data</code>.
     */
    public final TableField<StaffogTaskRecord, String> DATA =
    ...
    public <U> SelectField<U> mapping(
            Class<U> toType, Function3<? super Integer, ? super String, ? super String, ? extends U> from) {
