...
public class StaffogTask extends TableImpl<StaffogTaskRecord> {
     ...
     */
    public final TableField<StaffogTaskRecord, Integer> ID = createField(DSL.name("id"),
            SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>staffog.staffog_task.task</code>.
     */
    public final TableField<StaffogTaskRecord, String> TASK = createField(DSL.name("task"),
            SQLDataType.VARCHAR(2048).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_task.data</code>.
     */
    public final TableField<StaffogTaskRecord, String> DATA = createField(DSL.name("data"),
            SQLDataType.VARCHAR(2048).nullable(false), this, "");
