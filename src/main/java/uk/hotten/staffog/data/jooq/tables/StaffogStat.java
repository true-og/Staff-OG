...
public class StaffogStat extends TableImpl<StaffogStatRecord> {
     ...
     */
    public final TableField<StaffogStatRecord, String> NAME =
            createField(DSL.name("name"), SQLDataType.VARCHAR(2048).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_stat.stat</code>.
     */
    public final TableField<StaffogStatRecord, String> STAT =
            createField(DSL.name("stat"), SQLDataType.VARCHAR(2048).nullable(false), this, "");
