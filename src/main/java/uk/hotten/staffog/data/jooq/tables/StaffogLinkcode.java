...
public class StaffogLinkcode extends TableImpl<StaffogLinkcodeRecord> {
    ...
    public <U> SelectField<U> mapping(
            Class<U> toType, Function3<? super String, ? super String, ? super Boolean, ? extends U> from) {
