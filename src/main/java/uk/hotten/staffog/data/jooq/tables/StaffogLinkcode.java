...
public class StaffogLinkcode extends TableImpl<StaffogLinkcodeRecord> {
     ...
     */
    public final TableField<StaffogLinkcodeRecord, String> UUID = createField(DSL.name("uuid"),
            SQLDataType.VARCHAR(36).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_linkcode.code</code>.
     */
    public final TableField<StaffogLinkcodeRecord, String> CODE = createField(DSL.name("code"),
            SQLDataType.VARCHAR(5).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_linkcode.admin</code>.
     */
    public final TableField<StaffogLinkcodeRecord, Boolean> ADMIN = createField(DSL.name("admin"),
    ...
    public <U> SelectField<U> mapping(Class<U> toType,
            Function3<? super String, ? super String, ? super Boolean, ? extends U> from)
    {
