...
public class StaffogKick extends TableImpl<StaffogKickRecord> {
     ...
     */
    public final TableField<StaffogKickRecord, Long> ID = createField(DSL.name("id"),
            SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>staffog.staffog_kick.uuid</code>.
     */
    public final TableField<StaffogKickRecord, String> UUID = createField(DSL.name("uuid"),
            SQLDataType.VARCHAR(36).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_kick.reason</code>.
     */
    public final TableField<StaffogKickRecord, String> REASON = createField(DSL.name("reason"),
            SQLDataType.VARCHAR(2048).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_kick.by_uuid</code>.
     */
    public final TableField<StaffogKickRecord, String> BY_UUID = createField(DSL.name("by_uuid"),
            SQLDataType.VARCHAR(36).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_kick.by_name</code>.
     */
    public final TableField<StaffogKickRecord, String> BY_NAME = createField(DSL.name("by_name"),
            SQLDataType.VARCHAR(128).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_kick.time</code>.
     */
    public final TableField<StaffogKickRecord, Long> TIME = createField(DSL.name("time"),
    ...
    public <U> SelectField<U> mapping(
            Function6<? super Long, ? super String, ? super String, ? super String, ? super String, ? super Long, ? extends U> from)
    {
