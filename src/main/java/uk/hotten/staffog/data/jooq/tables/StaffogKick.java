...
public class StaffogKick extends TableImpl<StaffogKickRecord> {
     ...
     */
    public final TableField<StaffogKickRecord, String> BY_UUID =
            createField(DSL.name("by_uuid"), SQLDataType.VARCHAR(36).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_kick.by_name</code>.
     */
    public final TableField<StaffogKickRecord, String> BY_NAME =
            createField(DSL.name("by_name"), SQLDataType.VARCHAR(128).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_kick.time</code>.
     */
    public final TableField<StaffogKickRecord, Long> TIME =
