...
public class StaffogAudit extends TableImpl<StaffogAuditRecord> {
     ...
     */
    public final TableField<StaffogAuditRecord, Integer> ID = createField(DSL.name("id"),
            SQLDataType.INTEGER.nullable(false).identity(true), this, "");

    /**
     * The column <code>staffog.staffog_audit.type</code>.
     */
    public final TableField<StaffogAuditRecord, String> TYPE = createField(DSL.name("type"),
            SQLDataType.VARCHAR(2048).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_audit.data</code>.
     */
    public final TableField<StaffogAuditRecord, String> DATA = createField(DSL.name("data"),
            SQLDataType.VARCHAR(2048).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_audit.time</code>.
     */
    public final TableField<StaffogAuditRecord, Long> TIME = createField(DSL.name("time"),
