...
public class StaffogAudit extends TableImpl<StaffogAuditRecord> {
     ...
     */
    public final TableField<StaffogAuditRecord, Integer> ID =
     ...
     */
    public final TableField<StaffogAuditRecord, String> TYPE =
            createField(DSL.name("type"), SQLDataType.VARCHAR(2048).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_audit.data</code>.
     */
    public final TableField<StaffogAuditRecord, String> DATA =
            createField(DSL.name("data"), SQLDataType.VARCHAR(2048).nullable(false), this, "");

    /**
     * The column <code>staffog.staffog_audit.time</code>.
     */
    public final TableField<StaffogAuditRecord, Long> TIME =
    ...
    public <U> SelectField<U> mapping(
            Function4<? super Integer, ? super String, ? super String, ? super Long, ? extends U> from) {
